...
const Navbar = () => {
  ...
  return (
    <nav className='flex justify-between s:px-0 sm:px-0 md:px-[50px] lg:px-[70px] xl:px-[70px] py-5 bg-[#FCFDFC] sticky top-0 z-20'>
      {/* section links */}
      ...
      {/* logo */}
      <div className='s:ml-[38px] sm:ml-[38px] md:mr-[45px] lg:mr-[45px] xl:mr-[45px]'>
        <Logo />
      </div>
      {/* buy ticket */}
      <Link to='buyTicket' smooth={true} offset={-150} className='flex items-center s:hidden sm:hidden md:block lg:block xl:block'>
